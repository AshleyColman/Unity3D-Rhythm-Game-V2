...
public class BeatmapLoader : MonoBehaviour
{
    ...
    public Beatmap LoadOsuFile() => ReadOsuFile();
    public Beatmap ReadOsuFile()
    {
        ...
        string osuFilePath = $"{Application.persistentDataPath}/Beatmaps/OsuMap/file.osu";
        var reader = new StreamReader(osuFilePath);
        ...
        reader = new StreamReader(osuFilePath);
